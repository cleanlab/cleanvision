...
issues = images.find_issues(threshold = None, issues_checked={"Near Duplicates": {"hashtype": "whash", "hash_size": 8}}, verbose=False, num_preview=0) #the dictionary of issues and pandas dataframe of information
