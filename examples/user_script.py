...
issues = images.find_issues(threshold = None, issues_checked={"Corrupt":{}}, verbose=False, num_preview=0) #the dictionary of issues and pandas dataframe of information
